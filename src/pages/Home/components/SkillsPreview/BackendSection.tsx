  ...
  return (
    <section className="skills__preview__section">
      <div className="skills__preview__section-content skills__preview__section-content_backend">
        <SkillsPreviewItem src={ruby} alt="ruby" text="Ruby" id="ruby" />

        <SkillsPreviewItem src={rails} alt="rails" text="Rails" id="rails" />

        <SkillsPreviewItem src={nestjs} alt="nestjs" text="NestJs" id="nestjs" />
      </div>
