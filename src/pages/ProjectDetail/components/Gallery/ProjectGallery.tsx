    ...
    <div className="project-gallery">
      ...
      <div className="project-gallery__content">
        <div className="project-gallery__description">
          <h3 className="project-gallery__description__title">{project.screenshots[activeSlideIndex]?.title}</h3>
          <p className="project-gallery__description__texte">{project.screenshots[activeSlideIndex]?.description}</p>
        </div>
